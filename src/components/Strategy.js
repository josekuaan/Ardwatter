    ...
    return (
        <div className=' strategy-section'>
            ...
            <div className="step-content" data-aos="fade-up" data-aos-duration="3000" data-aos-easing="ease-in-sine">
                <div className="strategy-content lft">
                    <div className="steps"><h1 className="left"><span  style={{color:'#FF497C'}}>01</span>Strategy</h1></div>
            ...
            <div className="step-content right" data-aos="fade-up" data-aos-duration="3000" data-aos-easing="ease-in-sine">
                <div className="strategy-content rgt">
                    <div className="steps">Color scheme, layout, sitemap, and style. We will bring your brand to life with a one of a kind masterpiece, built just for you.</div>
                        ...
                        <div className="steps"><h1 className="right"><span  style={{color:'#A0CE4E'}}>02</span>Design</h1></div>
                    </div>
                </div>
            <div className="step-content" data-aos="fade-up" data-aos-duration="3000" data-aos-easing="ease-in-sine">
                <div className="strategy-content lft">
                    <div className="steps"><h1 className="left"><span  style={{color:'#00BEA3'}}>03</span>Develop</h1></div>
            ...
            <div className=" step-content right" data-aos="fade-up" data-aos-duration="3000" data-aos-easing="ease-in-sine">
                <div className="strategy-content rgt">
                    ...
                    <div className="steps"><h1 className="right" ><span style={{color:'#F1894C'}}>04</span> Support</h1></div>
                </div>
           </div>
           </div>
        </div>
