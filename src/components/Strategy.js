...
export default function Strategy() {
    return (
        <div className='strategy-section'>
            <div className="step-content" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-sine">
            ...
            <div className="step-content right" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-sine">
                <div className="strategy-content ">
